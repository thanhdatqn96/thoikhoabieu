								...
								<div class="card-content collapse show" style="">
									<div class="card-body">
										...
										<div class="form-group">
											...
											<hr>
											<button type="button" class="btn btn-success" id="xuattkb">Xuất thời khóa biểu</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card box-shadow-0 border-info bg-transparent" id="khaibao">
								...
								<div class="card-content collapse show" style="">
									<div class="card-body">
										<form class="form">
<!-- 											<div class="form-body">
												<h6 class="form-section"><i class="ft-user"></i> Thông tin email gửi</h6>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<input type="text" id="projectinput1" class="form-control input-sm" placeholder="Email" value="{{ Session::get('email') }}">															
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<input type="password" id="projectinput2" class="form-control input-sm" placeholder="Mật khẩu" name="lname">
														</div>
													</div>
												</div>
											</div> -->
				...
				<!-- 									<div class="col-md-3">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<button type="button" class="btn mr-1 mb-1 btn-info btn-sm">File đính kèm</button>
														</div>
													</div>
													<div class="col-md-1">
														<div class="form-group">
															<label>Gửi mail</label>
															<button type="button" class="btn mr-1 mb-1 btn-success btn-sm">Gửi</button>
														</div>
													</div>
													<div class="col-md-2">
														<div class="form-group">
										...
										<form class="form">
											<div class="form-body">
												<h6 class="form-section"><i class="ft-calendar"></i> Danh sách giáo viên cần gửi</h6>
												<div class="row">
													<div class="col-md-12">
